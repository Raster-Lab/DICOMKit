...
| C2 — Standard-derived, edition-stable | 59 | Carries PS3.x data that hasn't materially changed across recent editions | 🔄 **In progress** — 46 of 59 (Tag files, VR value types, encoding/pixel data, codecs) text-diffed |
...
### Verification — 🔄 in progress (46 of 59)
