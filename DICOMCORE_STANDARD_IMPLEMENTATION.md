...
| C2 — Standard-derived, edition-stable | 59 | Carries PS3.x data that hasn't materially changed across recent editions | 🔄 **In progress** — 32 of 59 (Tag files, VR value types) text-diffed |
...
### Verification — 🔄 in progress (32 of 59)
