...
| B2 — Stale or incorrect, no citation | 10 | Data gap or bug relative to 2026a, undocumented | 🔄 In progress — 8 of 10 done (P1, P3, P5, P6 SRDocumentType + ContextGroup) |
...
| [StructuredReporting/DICOMCode.swift](Sources/DICOMCore/StructuredReporting/DICOMCode.swift#L62) | **Text-diffed 2026-09-25** against PS3.16 2026a Annex D (5,116 DCM codes) and, for non-DCM meanings, every CID table. **29 of 93 entries are right; 64 are wrong.** The 5 duplicates in P6 are confirmed, and they are symptoms: (a) 18 entries carry a wrong number for a meaning that does have a DCM code (Summary is 121111 not 121070, Impression 121073 not 121077, Conclusion 121077 not 121076, Recommendation 121075, Subject Species 121034, Mammography CAD Report 111036, Chest CAD Report 112000, Colon CAD Report 112220, Study 113014, Series 113015, Height 121207, Image Region 111030, ...); (b) 2 differ only in capitalisation; (c) 13 are SCT (or NCIt) concepts, not DCM at all (Diameter is SCT 81827009, Volume 118565006, Length 410668003, Long Axis 103339001, Short Axis 103340004, ...), and the file's `longAxis`/`shortAxis` numbers are even swapped fragments of those SCT codes; (d) 7 "relationship codes" (`contains`, `hasProperties`, `inferredFrom`, ...) are not codes: relationships are `RelationshipType` values; (e) the remaining ~24 have no DCM code with that meaning at all (e.g. 121401-121408 are Derivation / Normality / Level of Significance / Selection Status ..., not Mean / Min / Max / Std Dev; 126000 is "Imaging Measurement Report"; C0034375 is a UMLS CUI). Nothing outside `DICOMCodeTests` uses these constants. **Awaiting a decision** on the public API. |
