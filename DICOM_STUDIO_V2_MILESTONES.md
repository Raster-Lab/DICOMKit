...
- [x] Define parameter schemas for all 39 CLI tools
  ...
  - [x] **Networking** (11 tools):
    ...
    - `dicom-mwl`: operation (query/create), create method (HL7/REST), host, port, HL7 port, AE titles, date range, modality filter, station name, patient demographics, procedure details, HL7 MSH sending/receiving application/facility
