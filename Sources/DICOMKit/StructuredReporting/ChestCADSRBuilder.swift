...
/// Reference: DICOM Supplement 65 - Chest Computer-Aided Detection SR
...
///
/// ChestCADSRBuilder provides a simplified API for creating documents that
/// contain computer-aided detection results for chest images, including
...
///
/// ## Finding Types
/// Chest CAD findings typically include:
/// - Lung nodules
/// - Mass lesions
/// - Consolidations
...
///
/// ## Supported Content
/// Chest CAD SR documents support:
...
/// - PNAME - Person names
/// - COMPOSITE, IMAGE - References to chest images (CT, X-ray)
...
public struct ChestCADSRBuilder: Sendable {
    ...
    ///   - processingDateTime: Optional processing date/time (ISO 8601 format)
    ...
    ///   - characteristics: Optional additional characteristics
    /// - Returns: A new builder with the added finding
    ...
    public func build() throws -> SRDocument {
        ...
        let document = SRDocument(
            sopClassUID: "1.2.840.10008.5.1.4.1.1.88.65", // Chest CAD SR SOP Class
    ...
    private func buildFinding(_ finding: ChestCADFinding) throws -> ContainerContentItem {
        ...
        contentItems.append(AnyContentItem(probItem))
    ...
    private func validate() throws {
        ...
        if findings.isEmpty {
            throw BuildError.validationError(
                "Chest CAD SR document must contain at least one finding"
            )
        }
...
/// Represents a CAD finding in a Chest CAD SR document
    ...
    public var concept: CodedConcept {
        ...
        case .consolidation:
            return CodedConcept(
                codeValue: "3128005",
                codingSchemeDesignator: "SRT",
                codeMeaning: "Pulmonary consolidation"
            )
        case .treeInBud:
            return CodedConcept(
                codeValue: "44914007",
