        ...
        case "dicom-convert":
            return [
                ...
                CLIParameterDefinition(
                    ...
                    helpText: "Target transfer syntax for DICOM-to-DICOM conversion — supports uncompressed and compressed encoding (PS3.5 §10). The picker shows the human-readable name; the CLI command emits the shortform recognised by `dicom-convert --transfer-syntax`.",
                    allowedValues: [
                        "",
                        "evle",
                        "ivle",
                    ...
                    valueLabels: [
                        "evle":               "Explicit VR Little Endian",
                        "ivle":               "Implicit VR Little Endian",
                        "evbe":               "Explicit VR Big Endian",
                        "deflate":            "Deflated Explicit VR Little Endian",
                        "jpeg-baseline":      "JPEG Baseline (Lossy)",
                        "jpeg-extended":      "JPEG Extended (Lossy)",
                        "jpeg-lossless":      "JPEG Lossless",
                        "jpeg-lossless-sv1":  "JPEG Lossless SV1",
                        "j2k-lossless":       "JPEG 2000 Lossless",
                        "j2k":                "JPEG 2000 (Lossy)",
                        "j2k-part2-lossless": "JPEG 2000 Part 2 Lossless",
                        "j2k-part2":          "JPEG 2000 Part 2 (Lossy)",
                        "htj2k-lossless":     "HTJ2K Lossless",
                        "htj2k-rpcl":         "HTJ2K RPCL Lossless",
                        "htj2k":              "HTJ2K (Lossy)",
                        "jpegls":             "JPEG-LS Lossless",
                        "jpegls-near":        "JPEG-LS Near-Lossless",
                        "rle":                "RLE Lossless",
                    ],
                    visibleWhen: CLIParameterVisibilityCondition(parameterId: "format", values: ["dicom"])
                ),
                CLIParameterDefinition(
                    id: "codec-backend", flag: "", displayName: "JPEG 2000 Codec",
                    parameterType: .flagPicker, placeholder: "j2kswift",
                    helpText: "Codec implementation used for JPEG 2000 family transfer syntaxes (Part 1, Part 2, HTJ2K). J2KSwift is the default and supports HTJ2K; OpenJPEG handles only JPEG 2000 Part 1 and Part 2.",
                    defaultValue: "j2kswift",
                    allowedValues: ["j2kswift", "openjpeg"],
                    valueLabels: [
                        "j2kswift": "J2KSwift (default)",
                        "openjpeg": "OpenJPEG",
                    ],
                    visibleWhen: CLIParameterVisibilityCondition(parameterId: "format", values: ["dicom"])
                ),
        ...
        case "dicom-convert":
            return [
                CLIExamplePreset(toolID: toolID, title: "Convert to Explicit VR Little Endian",
                                 ...
                                 commandString: "dicom-convert scan.dcm --output converted.dcm --format dicom --transfer-syntax evle"),
                ...
                CLIExamplePreset(toolID: toolID, title: "Batch Convert Directory",
                                 ...
                                 commandString: "dicom-convert input/ --output output/ --format dicom --transfer-syntax ivle --recursive"),
            ]
        case "dicom-query":
            return [
