...
|---|---|---|---|---|
| [dicom-anon](dicom-anon.md) | yes | 13/13 (100%) | OK | 4✅ / 0❌ · 2/13 flags |
| [dicom-archive](dicom-archive.md) | yes | 17/17 (100%) | OK | 6✅ / 0❌ · 4/17 flags |
| [dicom-compress](dicom-compress.md) | yes | 9/9 (100%) | OK | 8✅ / 1❌ · 3/9 flags |
| [dicom-convert](dicom-convert.md) | yes | 12/12 (100%) | OK | 2✅ / 0❌ · 2/12 flags |
...
| [dicom-export](dicom-export.md) | yes | 21/21 (100%) | OK | 2✅ / 0❌ · 2/21 flags |
| [dicom-image](dicom-image.md) | yes | 14/14 (100%) | OK | no scenarios |
| [dicom-info](dicom-info.md) | yes | 5/5 (100%) | OK | 16✅ / 0❌ · 5/5 flags |
| [dicom-json](dicom-json.md) | yes | 12/12 (100%) | OK | 4✅ / 0❌ · 3/12 flags |
...
| [dicom-pdf](dicom-pdf.md) | yes | 14/14 (100%) | OK | 0✅ / 1❌ · 5/14 flags |
| [dicom-pixedit](dicom-pixedit.md) | yes | 8/9 (89%) | INCOMPLETE | 2✅ / 0❌ · 3/9 flags |
...
| [dicom-study](dicom-study.md) | yes | 9/9 (100%) | OK | 6✅ / 4❌ · 4/9 flags |
...
| [dicom-xml](dicom-xml.md) | yes | 10/10 (100%) | OK | 4✅ / 0❌ · 3/10 flags |
...
**68 / 383 CLI flags (17.8%)** are exercised by ≥1 output scenario across 32 wired tools. The rest are the silent-coverage gap (the `⊘ not covered` flags above) — contract-driven auto-generation (plan Phase 2) drives this toward 100%. Machine-readable per-tool detail (incl. each tool's `uncoveredFlags`) is in `coverage.json`.
