...
**Output behavior:** 64 scenario(s) — 64 success / 0 drift.
...
| CT.dcm · quality-high | `compress FIXTURE -c rle --quality high --output OUTPUT` | ✅ success |
...
| syn-ct.dcm · quality-high | `compress FIXTURE -c rle --quality high --output OUTPUT` | ✅ success |
| syn-rle-dir · batch-decompress-recursive | `batch FIXTURE --decompress --recursive --output OUTPUT` | ✅ success |
